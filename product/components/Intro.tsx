...
export default function TextGenerateEffectDemo() {
  return (
    <div className="p-10">
<h1 className="text-3xl font-bold text-center text-white">About Me</h1>
{/* <TextGenerateEffect className="text-center text-sm" words={words} /> */}
<div className="flex justify-center">
<p className="font-semibold text-white text-center w-full md:w-3/5 p-4 font-['Montserrat']">
